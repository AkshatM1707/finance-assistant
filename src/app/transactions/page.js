      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-3">
            <Button
              className="flex items-center px-4 py-2 bg-white text-gray-800 border border-gray-300 rounded-md shadow-sm hover:bg-gray-100 transition"
  ...
  <table className="w-full">
    <thead>
      <tr className="border-b border-gray-300 bg-gray-100">
        <th className="text-left py-4 px-6 text-gray-700 font-medium">
          Description
        </th>
        <th className="text-left py-4 px-6 text-gray-700 font-medium">
          Category
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Upload a PDF containing transaction history in tabular
                    format
                  </p>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                      ...
                      <div className="text-sm text-green-700">
                        <p>
                          • {pdfUploadResult.summary.successful} transactions
                          imported
                        </p>
                        <p>
                          • {pdfUploadResult.summary.failed} errors encountered
                        </p>
                      ...
                      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        ...
                        <ul className="text-sm text-yellow-700 space-y-1">
                          ...
                          {pdfUploadResult.errors.length > 5 && (
                            <li>
                              • ... and {pdfUploadResult.errors.length - 5} more
                            </li>
                          )}
                        </ul>
                      </div>
